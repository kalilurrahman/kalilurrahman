...
import kaggleScreenshot from "@/assets/screenshots/apps/kaggle-profile.png";
import amazonScreenshot from "@/assets/screenshots/apps/amazon-author.png";
import masterProfileScreenshot from "@/assets/screenshots/apps/master-profile.png";
import mainPortfolioScreenshot from "@/assets/screenshots/main-portfolio.png";
import linktreeScreenshot from "@/assets/screenshots/apps/linktree.png";
import phdScreenshot from "@/assets/screenshots/apps/phd-research-assistant.png";

import krPromptsCollage from "@/assets/screenshots/prompts/kr-prompts-app_collage.png";
import techCuratorCollage from "@/assets/screenshots/apps/tech-curator-guide_collage.png";
import pocketNewsCollage from "@/assets/screenshots/apps/pocket-news_collage.png";
import islamicDuasCollage from "@/assets/screenshots/apps/islamic-duas_collage.png";
import trainingPortfolioScreenshot from "@/assets/screenshots/apps/training-portfolio.png";
import gccPlaybookScreenshot from "@/assets/screenshots/apps/gcc-playbook.png";
import quantumHubScreenshot from "@/assets/screenshots/apps/quantum-hub.png";
import agenticAIPromptsScreenshot from "@/assets/screenshots/prompts/agentic-ai-prompts.png";
import financePromptsScreenshot from "@/assets/screenshots/prompts/finance-prompts.png";
import acuitasScreenshot from "@/assets/screenshots/apps/acuitas-framework.png";
import socialAuthorityScreenshot from "@/assets/screenshots/apps/social-authority-hub.png";
import biztechQuizzerScreenshot from "@/assets/screenshots/apps/biztech-quizzer.png";
import newsAppScreenshot from "@/assets/screenshots/apps/news-app.png";
import farzi10thScreenshot from "@/assets/screenshots/apps/farzi-10th.png";
import arcadeGamesScreenshot from "@/assets/screenshots/apps/arcade-games.png";
import promptTerminalBuilderScreenshot from "@/assets/screenshots/prompts/prompt-terminal-builder.png";
import veritasQEScreenshot from "@/assets/screenshots/apps/veritas-qe-framework.png";
import gccCompassScreenshot from "@/assets/screenshots/apps/gcc-compass.png";
import corpUpskillScreenshot from "@/assets/screenshots/apps/corp-upskill.png";
import qeCompassScreenshot from "@/assets/screenshots/apps/qe-compass.png";
import execScribeScreenshot from "@/assets/screenshots/apps/exec-scribe.png";
import kaggleSkillHubScreenshot from "@/assets/screenshots/apps/kaggle-skill-hub.png";
import aiLiteracyHubScreenshot from "@/assets/screenshots/apps/ai-literacy-hub.png";
import interviewPrepScreenshot from "@/assets/screenshots/apps/interview-prep-vault.png";
import cyberLexiconScreenshot from "@/assets/screenshots/apps/cyber-lexicon-hub.png";
import quizBlitzScreenshot from "@/assets/screenshots/apps/quiz-blitz-hub.png";
...
const githubRepos = [
  { name: "kr-token-ops-hub", url: "https://github.com/kalilurrahman/kr-token-ops-hub", lang: "TypeScript", summary: "TokenOps — FinOps-style optimisation for LLM and AI token usage across enterprise AI workloads." },
  { name: "tokenops-atlas", url: "https://github.com/kalilurrahman/tokenops-atlas", lang: "JavaScript", summary: "TokenOps Atlas — reference atlas of token-cost patterns, model pricing and optimisation playbooks." },
  { name: "agentic-ai-in-pharma", url: "https://github.com/kalilurrahman/agentic-ai-in-pharma", lang: "HTML", summary: "Agentic AI in Pharma — applied agentic AI patterns and use cases across the pharmaceutical value chain." },
  { name: "kr-finance-prompt-hub", url: "https://github.com/kalilurrahman/kr-finance-prompt-hub", lang: "TypeScript", summary: "Curated finance-focused prompt library — financial analysis, market research, portfolio management and advisory." },
  { name: "kr-claudiator-skills", url: "https://github.com/kalilurrahman/kr-claudiator-skills", lang: "TypeScript", summary: "Claudiator — open-source PWA browser for Claude SKILL.md prompts with copy-ready frontmatter." },
  { name: "cancer-knowledge-explorer", url: "https://github.com/kalilurrahman/cancer-knowledge-explorer", lang: "TypeScript", summary: "Companion explorer to the Cancer Knowledge Book — searchable oncology data and references." },
  { name: "kr-gcc-playbook-hub", url: "https://github.com/kalilurrahman/kr-gcc-playbook-hub", lang: "TypeScript", summary: "Global Capability Center Playbook — frameworks, maturity models and operational guides for GCC leaders." },
  { name: "kr-test-automator", url: "https://github.com/kalilurrahman/kr-test-automator", lang: "TypeScript", summary: "TestForge AI — intelligent test automation with AI-assisted test generation, execution and reporting." },
  { name: "kr-phd-research-assistant", url: "https://github.com/kalilurrahman/kr-phd-research-assistant", lang: "TypeScript", summary: "PhD Research Assistant — AI-augmented workspace for literature review, citations and thesis structuring." },
  { name: "kalilurrahman", url: "https://github.com/kalilurrahman/kalilurrahman", lang: "TypeScript", summary: "GitHub profile README — portfolio across enterprise architecture, AI, QE and GCC leadership." },
  { name: "academic-research-paper-studio", url: "https://github.com/kalilurrahman/academic-research-paper-studio", lang: "TypeScript", summary: "Academic Research Paper Studio — workspace for drafting, reviewing and publishing research papers." },
  { name: "academic-research-skills", url: "https://github.com/kalilurrahman/academic-research-skills", lang: "Various", summary: "Academic Research Skills for Claude Code — research → write → review → revise → finalize skill suite." },
  { name: "career-ops", url: "https://github.com/kalilurrahman/career-ops", lang: "Various", summary: "AI-powered job-search system on Claude Code — 14 skill modes, Go dashboard, PDF generation, batch processing." },
  { name: "kr-app-builder-grid-playbook", url: "https://github.com/kalilurrahman/kr-app-builder-grid-playbook", lang: "Various", summary: "App Builder Grid Playbook — structured playbook for building AI-assisted app portfolios at speed." },
  { name: "tn-election-predictor", url: "https://github.com/kalilurrahman/tn-election-predictor", lang: "TypeScript", summary: "Tamil Nadu Election Predictor — constituency-level prediction dashboard with sentiment and simulation." },
  { name: "citaacc-ai-hub", url: "https://github.com/kalilurrahman/citaacc-ai-hub", lang: "TypeScript", summary: "CIT Alumni Association Chennai — AI Articles Hub for community knowledge sharing." },
  { name: "kr-claudiator-skills-original-prompts", url: "https://github.com/kalilurrahman/kr-claudiator-skills-original-prompts", lang: "Various", summary: "Original Claudiator SKILL.md prompt files — the curated source library powering Claudiator." },
  { name: "GCCLeadership", url: "https://github.com/kalilurrahman/GCCLeadership", lang: "Python", summary: "GCC Leadership — points of view on building, scaling and leading Global Capability Centers." },
  { name: "stock-data-auto-updater", url: "https://github.com/kalilurrahman/stock-data-auto-updater", lang: "Python", summary: "Stock Dataset Auto-Updater — Python automation that keeps the published OHLCV datasets fresh." },
  { name: "agenticAIVibeCodingProductBuilder", url: "https://github.com/kalilurrahman/agenticAIVibeCodingProductBuilder", lang: "TypeScript", summary: "Agentic AI-driven vibe coding product builder — autonomous agents collaborating to design and ship features." },
  { name: "AptestQualityEngineer", url: "https://github.com/kalilurrahman/AptestQualityEngineer", lang: "Python", summary: "Aptest QE — AI-assisted quality engineering platform that generates test plans, cases and defect reports." },
  { name: "kalilurrahman.github.io", url: "https://github.com/kalilurrahman/kalilurrahman.github.io", lang: "HTML", summary: "GitHub Pages portfolio — Master Profile Hub, PhD Research Assistant, and career summary pages." },
  { name: "awesome-llm-apps", url: "https://github.com/kalilurrahman/awesome-llm-apps", lang: "Python", summary: "Curated collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and OSS models." },
  { name: "Awesome-Prompts", url: "https://github.com/kalilurrahman/Awesome-Prompts", lang: "HTML", summary: "Hand-crafted prompt library — productivity, research, coding, writing and AI workflow prompts." },
  { name: "awesome-generative-ai-guide", url: "https://github.com/kalilurrahman/awesome-generative-ai-guide", lang: "Various", summary: "One-stop generative AI repository — research updates, interview prep, notebooks and learning paths." },
  { name: "QualityEngineeringBookByLLMs", url: "https://github.com/kalilurrahman/QualityEngineeringBookByLLMs", lang: "Various", summary: "QE Book Generated by LLMs — experimental book on Quality Engineering co-authored with LLMs." },
  { name: "QualityEngineeringArtefacts", url: "https://github.com/kalilurrahman/QualityEngineeringArtefacts", lang: "Various", summary: "Curated collection of test strategies, frameworks, templates and QE best practices." },
  { name: "1000_KaggleNoteBooks", url: "https://github.com/kalilurrahman/1000_KaggleNoteBooks", lang: "Jupyter Notebook", summary: "Archive of 1000+ Kaggle notebooks — EDA, feature engineering, ML models and competition solutions." },
  ...
  { name: "udemy_agents_course", url: "https://github.com/kalilurrahman/udemy_agents_course", lang: "Jupyter Notebook", summary: "Complete Agentic AI Engineering Course — notebooks and exercises on building autonomous AI agents." },
  { name: "SocialMediaArtefactSharing", url: "https://github.com/kalilurrahman/SocialMediaArtefactSharing", lang: "Various", summary: "Infographics, carousels and thought-leadership content shared across social channels." },
  { name: "NIFTY_50_STOCK_DATA", url: "https://github.com/kalilurrahman/NIFTY_50_STOCK_DATA", lang: "Data", summary: "NIFTY 50 index — historical daily prices and constituents for Indian stock market analysis." },
  { name: "NFLXStockData", url: "https://github.com/kalilurrahman/NFLXStockData", lang: "Data", summary: "Netflix (NFLX) historical OHLCV stock price data for analysis and backtesting." },
  { name: "MSFTStockdata", url: "https://github.com/kalilurrahman/MSFTStockdata", lang: "Data", summary: "Microsoft (MSFT) historical OHLCV stock price data for analysis and backtesting." },
  { name: "NVidiaStockdata", url: "https://github.com/kalilurrahman/NVidiaStockdata", lang: "Data", summary: "NVIDIA (NVDA) historical OHLCV stock price data for analysis and backtesting." },
  { name: "BoxOfficeData", url: "https://github.com/kalilurrahman/BoxOfficeData", lang: "Data", summary: "Box Office Data — global film revenues scraped from Box Office Mojo." },
  { name: "IPLAuctionData", url: "https://github.com/kalilurrahman/IPLAuctionData", lang: "Data", summary: "IPL Player Auction Data — historical bids, team assignments and price trends." },
];
